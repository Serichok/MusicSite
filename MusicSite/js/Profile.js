...
const editBtn = document.querySelector(".action-btn"); // first button = Edit Profile
...
form.addEventListener("submit", (e) => {
  ...
  document.querySelector(".profile-text h1").textContent = newName;
  document.querySelector(".profile-text p").textContent = newLocation;
